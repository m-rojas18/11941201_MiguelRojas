...
public class Zapatos extends Objeto {
    ...
    public Zapatos(String talla, String descripcion_suela, int comodidad, String color, String descripcion, String marca, String tamano, String calidad, Persona persona_ingreso) {
